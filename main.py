...
def update(message):
    bot.send_message(message.chat.id, '------ Меню обновлений бота ------\n'
                                           ...
                                           'Обновление 1.2.1 - добавление функции про информацию об обновлениях бота /update_info, добавление функции /talk_with_me, для напоминае про общение с ботом, исправление функции /tts 31.05.24\n'
